...
<div class="row">
    <div class="col form-group">
        ...
        <input type="text" name="name" id="name" value="{{ old('name', $seller->name) }}" required minlength="3" maxlength="50"
    ...
    <div class="col form-group">
        ...
        <input type="text" name="surname" id="surname" value="{{ old('surname', $seller->surname) }}" required minlength="3" maxlength="50"
...
<div class="row">
    <div class="col">
        ...
        <input type="tel" name="document" id="document" value="{{ old('document', $seller->document) }}"
    ...
    <div class="col">
        ...
        <input type="tel" name="cellphone" id="cellphone" value="{{ old('cellphone', $seller->cellphone) }}"
...
<div class="row">
    <div class="col">
        ...
        <input type="text" name="address" id="address" value="{{ old('address', $seller->address) }}" required minlength="5" maxlength="100"
    ...
    <div class="col">
        ...
        <input type="email" name="email" id="email" value="{{ old('email', $seller->email) }}" required minlength="5" maxlength="100"
